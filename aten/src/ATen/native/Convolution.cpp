...
at::Tensor conv1d_symint(
    ...
    SymIntArrayRef stride, SymIntArrayRef padding, SymIntArrayRef dilation, const c10::SymInt& groups) {
...
at::Tensor conv_transpose1d_symint(
    const Tensor& input_, const Tensor& weight, const c10::optional<Tensor>& bias_opt,
    SymIntArrayRef stride, SymIntArrayRef padding, SymIntArrayRef output_padding, const c10::SymInt& groups, SymIntArrayRef dilation) {
  // See [Note: hacky wrapper removal for optional tensor]
  c10::MaybeOwned<Tensor> bias_maybe_owned = at::borrow_from_optional_tensor(bias_opt);
  const Tensor& bias = *bias_maybe_owned;
